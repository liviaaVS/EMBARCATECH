...
void send_command(const char *cmd) {
    ...
    uart_puts(UART_ID, "\r\n");  // Adiciona a quebra de linha necessária para comandos AT
    sleep_ms(2000);  // Aguarde a resposta
}
...
#define WIFI_SSID "brisa-4217471"  // Substitua pelo nome da sua rede Wi-Fi
#define WIFI_PASS "1enxcbxm" // Substitua pela senha da sua rede Wi-Fi
